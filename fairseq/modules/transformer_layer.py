...
class TransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    """
    def __init__(
        self, args, no_encoder_attn=False, add_bias_kv=False, add_zero_attn=False, layernum=0
    ):
        super().__init__()
        ...
        if no_encoder_attn and not self.noLN:
    ...
    def forward(
        ...
        if self.self_attn_unmasked is not None:
            ...
            if prev_attn_state is not None:
                ...
                self.self_attn_unmasked._set_input_buffer(incremental_state, saved_state)
