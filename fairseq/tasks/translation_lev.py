...
class TranslationLevenshteinTask(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            choices=['random_delete', 'random_mask', 'no_noise', 'full_mask', 'par_mask', 'fifteenpct_mask',
                     'random_central_mask'])
    ...
    def inject_noise(self, target_tokens, update_num=None):
        ...
        def _random_mask(target_tokens, update_num):
            pad = self.tgt_dict.pad()
            bos = self.tgt_dict.bos()
            eos = self.tgt_dict.eos()
        ...
        if self.args.noise == 'random_delete':
            ...
            return _random_mask(target_tokens, update_num)
    ...
    def train_step(self,
                   ...
                   ignore_grad=False):
        model.train()
        sample['prev_target'] = self.inject_noise(sample['target'], update_num)
